package yezan.customSwing.view;
...
public class BasicPhotoUI extends PhotoUI implements MouseListener, MouseMotionListener, KeyListener
{
	...
	public Dimension getPreferredSize(JComponent c)
	{
		...
		Image image = bpc.getPhoto().getImage();
...
//		Dimension thumbnailSize = getThumbnailSize(c);
//
...
//		
//		System.out.println("Drawing Image container at "+c.getLocation()+"; Dimensions : "+totalSize);
//		Rectangle imageContainer = new Rectangle(new Point(0, 0), totalSize);
//		g2D.setPaint(new Color(189, 195, 199)); //rgb(236, 240, 241)
//		g2D.fill(imageContainer);
//		
//		BasicPhotoComponent bpc = (BasicPhotoComponent) c;
...
//	}
	...
	public void paint(Graphics g, JComponent c)
	{
		...
		ShapeNode imageContainer = bpc.getImageContainer();
		imageContainer.setBounds(new Rectangle(new Point(0, 0), totalSize));
		imageContainer.setBackgroundColor(new Color(189, 195,  199));
		
		ImageNode image = bpc.getPhoto();
		image.setBounds(new Rectangle(thumbnailLocation, thumbnailSize));
		
		/** TODO: 
		 		- Delegate this verification to controller
		 		- Stroke strokes in a PathNode for example
		 		
		 	 Note: When an image is flipped toggle visibility of some nodes ....
		 */
